...
export const StoredToolArtifactRecordSchema = Schema.Struct({
  ...
  openApiRawToolId: Schema.NullOr(Schema.String),
  openApiOperationId: Schema.NullOr(Schema.String),
  openApiTagsJson: Schema.NullOr(Schema.String),
...
export const ToolArtifactStorageSchema = Schema.transform(
  ...
  StoredToolArtifactRecordSchema,
  {
    ...
    decode: (row) => ({
      ...
      openApiRawToolId: row.openApiRawToolId,
      openApiOperationId: row.openApiOperationId,
      openApiTagsJson: row.openApiTagsJson,
    ...
    encode: (record) => ({
      ...
      openApiRawToolId: record.openApiRawToolId,
      openApiOperationId: record.openApiOperationId,
      openApiTagsJson: record.openApiTagsJson,
